...
class AnggotaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('staff-lapangan.anggota.index',compact('anggota'));
    }
    ...
    public function create()
    {
        ...
        $majlis = Majlis::where('kantor_id',Auth::user()->kantor_id)->where('petugas_id',Auth::user()->id)->latest()->get();
        return view('staff-lapangan.anggota.create',compact('tempat_lahir','majlis','provinsi','jenis_usaha'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('staff-lapangan.anggota.index')->with("success", "Berhasil registrasi anggota");
        } catch (\Throwable $th) {
            DB::rollBack();
            return redirect()->route('staff-lapangan.anggota.index')->with("error", "Gagal registrasi anggota!");
        }
    }
    ...
    public function show(string $id)
    {
        ...
        return view('staff-lapangan.anggota.detail',compact('anggota','alamat','usaha','usaha_pasangan','file_identitas','file_selfie_identitas','file_kartu_keluarga','file_bukti_pembayaran_registrasi'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $file_kartu_keluarga = LampiranRegistrasiAnggota::where('anggota_id',$id)->where('jenis','Kartu Keluarga')->first();
        $file_bukti_pembayaran_registrasi = LampiranRegistrasiAnggota::where('anggota_id',$id)->where('jenis','Bukti Pembayaran Registrasi')->first();
        return view('staff-lapangan.anggota.edit',compact('jenis_usaha','anggota','usaha','usaha_pasangan','alamat','provinsi','majlis','tempat_lahir','file_identitas','file_selfie_identitas','file_kartu_keluarga','file_bukti_pembayaran_registrasi'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if(!empty($anggota)){
            try {
                ...
                DB::commit();
                return redirect()->route('staff-lapangan.anggota.index')->with("success", "Berhasil mengedit anggota");
            } catch (\Throwable $th) {
                DB::rollBack();
                return redirect()->route('staff-lapangan.anggota.index')->with("error", "Gagal mengedit anggota !");
            }
        }else{
            return redirect()->route('staff-lapangan.anggota.index')->with("error", "Gagal mengedit anggota, harap hubungi admin !");
        }
    }
