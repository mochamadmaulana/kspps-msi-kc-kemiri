        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-4 mb-3">
                    ...
                    <input type="number" name="jumlah_keluarga" class="form-control @error('jumlah_keluarga') is-invalid @enderror" value="{{ @old('jumlah_keluarga',$anggota->jumlah_keluarga) }}" placeholder="Jumlah Keluarga..">
                    @error('jumlah_keluarga')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-lg-4 mb-3">
                    <div class="form-label">Pendapatan Lain-lain</div>
                    <input type="number" name="pendapatan_lain_lain" class="form-control @error('pendapatan_lain_lain') is-invalid @enderror" value="{{ @old('pendapatan_lain_lain',$anggota->pendapatan_lain_lain) }}" placeholder="Rp..">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-4 mb-3">
                    ...
                    <input type="number" name="nomor_identitas_pasangan" class="form-control @error('nomor_identitas_pasangan') is-invalid @enderror" value="{{ @old('nomor_identitas_pasangan',$anggota->pasangan->nomor_identitas) }}" placeholder="No. Identitas..">
                ...
                <div class="col-lg-4 mb-3">
                    <div class="form-label required">No. Telepone</div>
                    <input type="number" name="nomor_telepone_pasangan" class="form-control @error('nomor_telepone_pasangan') is-invalid @enderror" value="{{ @old('nomor_telepone_pasangan',$anggota->pasangan->nomor_telepone) }}" placeholder="No. Telepone..">
