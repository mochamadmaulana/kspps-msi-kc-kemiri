@extends('layout.staff_lapangan',['title_satu'=>'Form Edit','title_dua'=>'Profile Akun'])

@push('btn-page-header')
<div class="col-auto ms-auto d-print-none">
    <div class="btn-list">
        <a href="{{ route('staff-lapangan.profile.index') }}" class="btn btn-secondary d-none d-sm-inline-block">
        ...
        <a href="{{ route('staff-lapangan.profile.index') }}" class="btn btn-secondary d-sm-none btn-icon">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-back" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 11l-4 4l4 4m-4 -4h11a4 4 0 0 0 0 -8h-1" /></svg>
        </a>
    </div>
</div>
...
@section('page-body')
<form action="{{ route('staff-lapangan.profile.update') }}" method="POST" class="card">
    @csrf
    @method('put')
    <div class="card-body">
        <div class="row">
