        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="list-group list-group-flush list-group-hoverable">
                    ...
                    <a href="{{ route('staff-lapangan.profile.edit') }}" class="btn btn-success">
    ...
    <div class="col-lg-3">
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        @else
                        <form action="{{ route('staff-lapangan.profile.delete-foto-profile') }}" method="POST" class="d-grid">
                            @csrf
                            @method('delete')
        ...
        <div class="col-12">
            <div class="card my-2">
                ...
                <div class="card-body">
                    <form action="{{ route('staff-lapangan.profile.update-password') }}" method="POST">
                        @csrf
                        <div class="mb-3">
...
<div class="modal modal-blur fade" id="modal-upload-foto-profile" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('staff-lapangan.profile.upload-foto-profile') }}" method="POST" enctype="multipart/form-data">
                @csrf
