...
<div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="list-group list-group-flush">
                    @if ($identitas != NULL)
                    <a href="{{ route('admin.anggota.registrasi.identitas-edit',[$data_regist->id,$identitas->id]) }}" class="list-group-item list-group-item-action text-success active">
    ...
    <div class="col-lg">
        <form action="{{ route('admin.anggota.registrasi.identitas-store',$data_regist->id) }}" method="POST">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">EDIT IDENTITAS KTP/SIM</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="form-selectgroup">
                                <label class="form-selectgroup-item">
                                    <input type="radio" name="jenis_keanggotaan" value="Majlis" class="form-selectgroup-input" @if(@old('jenis_keanggotaan',$identitas->jenis_keanggotaan) == 'Majlis') checked @endif>
                                    <span class="form-selectgroup-label">
                                        <span class="p-auto">Majlis</span>
                                    </span>
                                </label>
                                <label class="form-selectgroup-item">
                                    <input type="radio" name="jenis_keanggotaan" value="Umum" class="form-selectgroup-input" @if(@old('jenis_keanggotaan',$identitas->jenis_keanggotaan) == 'Umum') checked @endif>
                                    <span class="form-selectgroup-label">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <select name="majlis" class="form-select @error('majlis') is-invalid @enderror" id="majlis" data-placeholder="pilih majlis">
                                <option value=""></option>
                                @foreach ($majlis as $m)
                                <option value="{{ $m->id }}" @if(@old('majlis',$identitas->majlis_id) == $m->id) selected @endif>{{ $m->kode }} {{ $m->nama }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="form-selectgroup">
                                <label class="form-selectgroup-item">
                                    <input type="radio" name="jenis_identitas" value="KTP" class="form-selectgroup-input" @if(@old('jenis_identitas',$identitas->jenis_identitas) == 'KTP') checked @endif>
                                    <span class="form-selectgroup-label">
                                        <span class="p-auto">KTP</span>
                                    </span>
                                </label>
                                <label class="form-selectgroup-item">
                                    <input type="radio" name="jenis_identitas" value="SIM" class="form-selectgroup-input" @if(@old('jenis_identitas',$identitas->jenis_identitas) == 'SIM') checked @endif>
                                    <span class="form-selectgroup-label">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="number" name="nomor_identitas" class="form-control @error('nomor_identitas') is-invalid @enderror" value="{{ @old('nomor_identitas',$identitas->nomor_identitas) }}" placeholder="No. Identitas..">
                            @error('nomor_identitas')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-lg-6 mb-3">
                            <div class="form-label required">No. Kartu Keluarga</div>
                            <input type="number" name="nomor_kartu_keluarga" class="form-control @error('nomor_kartu_keluarga') is-invalid @enderror" value="{{ @old('nomor_kartu_keluarga',$identitas->nomor_kartu_keluarga) }}" placeholder="No. Kartu Keluarga..">
                            @error('nomor_kartu_keluarga')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-lg-6 mb-3">
                            <div class="form-label required">Nama Lengkap</div>
                            <input type="text" name="nama_lengkap" class="form-control @error('nama_lengkap') is-invalid @enderror" value="{{ @old('nama_lengkap',$identitas->nama_lengkap) }}" placeholder="Nama Lengkap..">
                            @error('nama_lengkap')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-lg-6 mb-3">
                            <div class="form-label">Email</div>
                            <input type="text" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ @old('email',$identitas->email) }}" placeholder="Email..">
                            @error('email')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-lg-6 mb-3">
                            <div class="form-label required">No. Telepone</div>
                            <input type="number" name="nomor_telepone" class="form-control @error('nomor_telepone') is-invalid @enderror" value="{{ @old('nomor_telepone',$identitas->nomor_telepone) }}" placeholder="No. Telepone..">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <select name="tempat_lahir" class="form-select @error('tempat_lahir') is-invalid @enderror" id="tempat-lahir" data-placeholder="pilih tempat lahir">
                                ...
                                <option value="{{ $tl->id }}" @if(@old('tempat_lahir',$identitas->tempat_lahir_id) == $tl->id) selected @endif>{{ $tl->nama_kota }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="date" name="tanggal_lahir" class="form-control @error('tanggal_lahir') is-invalid @enderror" value="{{ @old('tanggal_lahir',$identitas->tanggal_lahir) }}">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="form-selectgroup">
                                <label class="form-selectgroup-item">
                                    <input type="radio" name="jenis_kelamin" value="Laki-Laki" class="form-selectgroup-input" @if(@old('jenis_kelamin',$identitas->jenis_kelamin) == 'Laki-Laki') checked @endif>
                                    <span class="form-selectgroup-label">
                                ...
                                <label class="form-selectgroup-item">
                                    <input type="radio" name="jenis_kelamin" value="Perempuan" class="form-selectgroup-input" @if(@old('jenis_kelamin',$identitas->jenis_kelamin) == 'Perempuan') checked @endif>
                                    <span class="form-selectgroup-label">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <select name="agama" class="form-select @error('agama') is-invalid @enderror" id="agama" data-placeholder="pilih agama">
                                <option value=""></option>
                                <option value="Islam" @if (@old('agama',$identitas->agama) == 'Islam') selected @endif>Islam</option>
                                <option value="Hindu" @if (@old('agama',$identitas->agama) == 'Hindu') selected @endif>Hindu</option>
                                <option value="Budha" @if (@old('agama',$identitas->agama) == 'Budha') selected @endif>Budha</option>
                                <option value="Protestan" @if (@old('agama',$identitas->agama) == 'Protestan') selected @endif>Protestan</option>
                                <option value="Katolik" @if (@old('agama',$identitas->agama) == 'Katolik') selected @endif>Katolik</option>
                                <option value="Khonghucu" @if (@old('agama',$identitas->agama) == 'Khonghucu') selected @endif>Khonghucu</option>
                            </select>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <select name="status_pernikahan" class="form-select @error('status_pernikahan') is-invalid @enderror" id="status-pernikahan" data-placeholder="pilih status pernikahan">
                                <option value=""></option>
                                <option value="Belum Menikah" @if (@old('status_pernikahan',$identitas->status_pernikahan) == 'Belum Menikah') selected @endif>Belum Menikah</option>
                                <option value="Nikah" @if (@old('status_pernikahan',$identitas->status_pernikahan) == 'Nikah') selected @endif>Nikah</option>
                                <option value="Cerai" @if (@old('status_pernikahan',$identitas->status_pernikahan) == 'Cerai') selected @endif>Cerai</option>
                                <option value="Janda/Duda" @if (@old('status_pernikahan',$identitas->status_pernikahan) == 'Janda/Duda') selected @endif>Janda/Duda</option>
                            </select>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <select name="pendidikan_terakhir" class="form-select @error('pendidikan_terakhir') is-invalid @enderror" id="pendidikan-terakhir" data-placeholder="pilih pendidikan terakhir">
                                <option value=""></option>
                                <option value="Tidak Bersekolah" @if (@old('pendidikan_terakhir',$identitas->pendidikan_terakhir) == 'Tidak Bersekolah') selected @endif>Tidak Bersekolah</option>
                                <option value="SD" @if (@old('pendidikan_terakhir',$identitas->pendidikan_terakhir) == 'SD') selected @endif>SD</option>
                                <option value="SMP" @if (@old('pendidikan_terakhir',$identitas->pendidikan_terakhir) == 'SMP') selected @endif>SMP</option>
                                <option value="SMA" @if (@old('pendidikan_terakhir',$identitas->pendidikan_terakhir) == 'SMA') selected @endif>SMA</option>
                                <option value="D3" @if (@old('pendidikan_terakhir',$identitas->pendidikan_terakhir) == 'D3') selected @endif>Diploma 3</option>
                                <option value="Sarjana 1" @if (@old('pendidikan_terakhir',$identitas->pendidikan_terakhir) == 'Sarjana 1') selected @endif>Sarjana 1</option>
                                <option value="Sarjana 2" @if (@old('pendidikan_terakhir',$identitas->pendidikan_terakhir) == 'Sarjana 2') selected @endif>Sarjana 2</option>
                                <option value="Sarjana 3" @if (@old('pendidikan_terakhir',$identitas->pendidikan_terakhir) == 'Sarjana 3') selected @endif>Sarjana 3</option>
                            </select>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" name="nama_ibu_kandung" class="form-control @error('nama_ibu_kandung') is-invalid @enderror" value="{{ @old('nama_ibu_kandung',$identitas->nama_ibu_kandung) }}" placeholder="Nama Ibu Kandung..">
                            @error('nama_ibu_kandung')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-lg-6 mb-3">
                            <div class="form-label required">Jumlah Keluarga</div>
                            <input type="number" name="jumlah_keluarga" class="form-control @error('jumlah_keluarga') is-invalid @enderror" value="{{ @old('jumlah_keluarga',$identitas->jumlah_keluarga) }}" placeholder="Jumlah Keluarga..">
