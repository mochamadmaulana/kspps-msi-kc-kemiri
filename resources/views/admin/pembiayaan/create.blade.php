@extends('layout.admin',['title_satu'=>'Form Tambah','title_dua'=>'Pembiayaan'])

@push('btn-page-header')
<div class="col-auto ms-auto d-print-none">
    <div class="btn-list">
        <a href="{{ route('admin.pembiayaan.index') }}" class="btn btn-secondary d-none d-sm-inline-block">
        ...
        <a href="{{ route('admin.pembiayaan.index') }}" class="btn btn-secondary d-sm-none btn-icon">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-back" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 11l-4 4l4 4m-4 -4h11a4 4 0 0 0 0 -8h-1" /></svg>
        </a>
    </div>
</div>
...
@section('page-body')
<form action="{{ route('admin.pembiayaan.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-4 mb-3">
                    <div class="form-label">Nama Anggota</div>
                    <input type="text" class="form-control" value="{{ Session::get('nama_lengkap') }}" readonly>
                </div>
                <div class="col-lg-4 mb-3">
                    <div class="form-label">Tempat, Tgl. Lahir</div>
                    <input type="text" class="form-control" value="{{ Session::get('tempat_tanggal_lahir') }}" readonly>
                </div>
                <div class="col-lg-4 mb-3">
    ...
    <div class="card my-3">
        <div class="card-header">
            <h1 class="card-title">Data Pasangan</h1>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-4 mb-3">
                    <label class="form-label required">Nama Pasangan</label>
                    <select name="kota_kabupaten_identitas" class="form-select"></select>
                </div>
                <div class="col-lg-4 mb-3">
                    <label class="form-label required">Tempat, Tgl. Lahir</label>
                    <select name="kota_kabupaten_identitas" class="form-select" id="kota-kabupaten-identitas"></select>
                </div>
                <div class="col-lg-4 mb-3">
                    <div class="form-label required">No. Identitas </div>
                    <input type="text" name="alamat_identitas" class="form-control @error('alamat_identitas') is-invalid @enderror" value="{{ @old('alamat_identitas') }}" placeholder="Alamat Identitas {{ session()->get('identitas') }}..">
