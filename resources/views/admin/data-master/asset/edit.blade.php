@extends('layout.admin',['title_satu'=>'Form Edit','title_dua'=>'Asset'])
...
@section('page-body')
<form action="{{ route('admin.data-master.asset.update',$asset->id) }}" method="POST" class="card">
    @csrf
    @method('put')
    <div class="card-body">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="mb-3">
                    ...
                    <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" rows="3" placeholder="Deskripsi.." autofocus>{{ @old('deskripsi',$asset->deskripsi) }}</textarea>
                    @error('deskripsi')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-lg-6 mb-3">
                    <div class="form-label required">Nilai Asset</div>
                    <input type="number" name="nilai_asset" class="form-control @error('nilai_asset') is-invalid @enderror" value="{{ @old('nilai_asset',$asset->nilai) }}" placeholder="Rp...">
