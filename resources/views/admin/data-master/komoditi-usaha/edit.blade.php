@extends('layout.admin',['title_satu'=>'Form Edit','title_dua'=>'Komoditi Usaha'])
...
@section('page-body')
<form action="{{ route('admin.data-master.komoditi-usaha.update',$komoditi_usaha->id) }}" method="POST" class="card">
    @csrf
    @method('put')
    <div class="card-body">
        <div class="row">
            <div class="col-lg-4 mb-3">
                ...
                <select name="jenis_usaha" class="form-select @error('jenis_usaha') is-invalid @enderror" id="jenis-usaha" data-placeholder="pilih jenis usaha">
                    ...
                    <option value="{{ $ju->id }}" @if(@old('jenis_usaha',$komoditi_usaha->jenis_usaha_id) == $ju->id) selected @endif>{{ $ju->nama }} ({{ $ju->kode }})</option>
                    @endforeach
                </select>
            ...
            <div class="col-lg-4 mb-3">
                ...
                <input type="text" name="komoditi" class="form-control @error('komoditi') is-invalid @enderror" value="{{ @old('komoditi',$komoditi_usaha->nama ) }}" placeholder="Komoditi..">
