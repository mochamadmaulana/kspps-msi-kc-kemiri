@extends('layout.admin',['title_satu'=>'Form Tambah','title_dua'=>'Anggota'])
        ...
        <div class="card-body">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-6 mb-3 mb-sm-0">
                                    <div class="form-label">RT</div>
                                    <input type="number" name="rt_usaha" class="form-control @error('rt_usaha') is-invalid @enderror" value="{{ @old('rt_usaha') }}" placeholder="RT..">
                                    @error('rt_usaha')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-6 mb-3 mb-sm-0">
                                    <div class="form-label">RW</div>
                                    <input type="number" name="rw_usaha" class="form-control @error('rw_usaha') is-invalid @enderror" value="{{ @old('rw_usaha') }}" placeholder="RW..">
                        ...
                        <div class="col-lg-6">
                            <div class="form-label">Kode Pos</div>
                            <input type="number" name="kode_pos_usaha" class="form-control @error('kode_pos_usaha') is-invalid @enderror" value="{{ @old('kode_pos_usaha') }}" placeholder="Kode Pos..">
                ...
                <div class="col-lg-4 mb-3">
                    ...
                    <input type="number" name="pendapatan_perbulan" class="form-control @error('pendapatan_perbulan') is-invalid @enderror" value="{{ @old('pendapatan_perbulan') }}" placeholder="Rp..">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-4 mb-3">
                    ...
                    <input type="number" name="nomor_identitas_pasangan" class="form-control @error('nomor_identitas_pasangan') is-invalid @enderror" value="{{ @old('nomor_identitas_pasangan') }}" placeholder="No. Identitas..">
                ...
                <div class="col-lg-4 mb-3">
                    <div class="form-label required">No. Telepone</div>
                    <input type="number" name="nomor_telepone_pasangan" class="form-control @error('nomor_telepone_pasangan') is-invalid @enderror" value="{{ @old('nomor_telepone_pasangan') }}" placeholder="No. Telepone..">
    ...
    <div class="card my-3">
        ...
        <div class="card-body">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-6 mb-3 mb-sm-0">
                                    <div class="form-label">RT</div>
                                    <input type="number" name="rt_usaha_pasangan" class="form-control @error('rt_usaha_pasangan') is-invalid @enderror" value="{{ @old('rt_usaha_pasangan') }}" placeholder="RT..">
                                    @error('rt_usaha_pasangan')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-6 mb-3 mb-sm-0">
                                    <div class="form-label">RW</div>
                                    <input type="number" name="rw_usaha_pasangan" class="form-control @error('rw_usaha_pasangan') is-invalid @enderror" value="{{ @old('rw_usaha_pasangan') }}" placeholder="RW..">
                        ...
                        <div class="col-lg-6">
                            <div class="form-label">Kode Pos</div>
                            <input type="number" name="kode_pos_usaha_pasangan" class="form-control @error('kode_pos_usaha_pasangan') is-invalid @enderror" value="{{ @old('kode_pos_usaha_pasangan') }}" placeholder="Kode Pos..">
                ...
                <div class="col-lg-4 mb-3">
                    <div class="form-label required">Pendapatan Perbulan</div>
                    <input type="number" name="pendapatan_perbulan_pasangan" class="form-control @error('pendapatan_perbulan_pasangan') is-invalid @enderror" value="{{ @old('pendapatan_perbulan_pasangan') }}" placeholder="Rp..">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-4 mb-3">
                    ...
                    <input type="number" name="biaya" class="form-control @error('biaya') is-invalid @enderror" value="{{ @old('biaya',50000) }}" placeholder="Biaya..">
