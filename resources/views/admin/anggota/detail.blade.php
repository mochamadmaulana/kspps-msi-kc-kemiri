@extends('layout.admin',['title_satu'=>'Detail','title_dua'=>'Anggota'])
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="col-lg fst-italic">
                        ...
                        @if ($anggota->registrasi->persetujuan_admin != 'Diterima' && $anggota->registrasi->status != 'Ditolak')
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Form Pilih Ketua</h5>
            ...
            <form action="#" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="nama_majlis">
                    <div class="mb-3">
...
<div class="modal modal-blur fade" id="modal-persetujuan-admin" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.anggota.persetujuan-registrasi',$anggota->id) }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
...
<div class="modal modal-blur fade" id="modal-ajukan-ulang-registrasi" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.anggota.pengajuan-ulang-registrasi',$anggota->id) }}" method="POST">
                @csrf
                @method('put')
                <div class="modal-body">
