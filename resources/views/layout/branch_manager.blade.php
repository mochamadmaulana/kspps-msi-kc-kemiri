                ...
                <div class="navbar-nav flex-row order-md-last">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            <a href="{{ route('branch-manager.profile.index') }}" class="dropdown-item {{ Request::is('branch-manager/profile*') ? 'active text-primary' : '' }}">Profile</a>
        ...
        <header class="navbar-expand-md">
            <div class="collapse navbar-collapse" id="navbar-menu">
                <div class="navbar">
                    <div class="container-xl">
                        <ul class="navbar-nav">
                            <li class="nav-item {{ Request::is('branch-manager/dashboard*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('branch-manager.dashboard') }}">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block {{ Request::is('branch-manager/dashboard*') ? 'text-primary' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('branch-manager/pembiayaan*') ? 'active' : '' }}">
                                <a class="nav-link" href="#">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block {{ Request::is('branch-manager/pembiayaan*') ? 'text-primary' : '' }}">
