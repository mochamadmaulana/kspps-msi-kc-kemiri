                ...
                <div class="navbar-nav flex-row order-md-last">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            <a href="{{ route('admin.profile.index') }}" class="dropdown-item {{ Request::is('admin/profile*') ? 'active text-primary' : '' }}">Profile</a>
                        ...
                        <ul class="navbar-nav">
                                ...
                                <div class="dropdown-menu">
                                    <div class="dropdown-menu-columns">
                                        <div class="dropdown-menu-column">
                                            <a href="{{ route('admin.data-master.piutang.index') }}" class="dropdown-item {{ Request::is('admin/data-master/piutang*') ? 'active' : '' }}">
                                                Piutang
                                            </a>
                                            <a href="{{ route('admin.data-master.asset.index') }}" class="dropdown-item {{ Request::is('admin/data-master/asset*') ? 'active' : '' }}">
                                                Asset
                                            </a>
                                            <a href="{{ route('admin.data-master.karyawan.index') }}" class="dropdown-item {{ Request::is('admin/data-master/karyawan*') ? 'active' : '' }}">
                                                Karyawan
                                            </a>
                                            <a href="{{ route('admin.data-master.kantor.index') }}" class="dropdown-item {{ Request::is('admin/data-master/kantor*') ? 'active' : '' }}">
                                                Kantor
                                            </a>
                                            <a href="{{ route('admin.data-master.majlis.index') }}" class="dropdown-item {{ Request::is('admin/data-master/majlis*') ? 'active' : '' }}">
                                                Majlis
                                            </a>
                                            <a href="{{ route('admin.data-master.komoditi-usaha.index') }}" class="dropdown-item {{ Request::is('admin/data-master/komoditi-usaha*') ? 'active' : '' }}">
                                                Komoditi Usaha
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <li class="nav-item {{ Request::is('admin/anggota*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('admin.anggota.index') }}">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block {{ Request::is('admin/anggota*') ? 'text-primary' : '' }}">
                            ...
                            <li class="nav-item {{ Request::is('admin/pembiayaan*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('admin.pembiayaan.index') }}">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block {{ Request::is('admin/pembiayaan*') ? 'text-primary' : '' }}">
                            ...
                            <li class="nav-item dropdown {{ Request::is('admin/laporan*') ? 'active' : '' }}">
                                <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block {{ Request::is('admin/laporan*') ? 'text-primary' : '' }}">
                                ...
                                <div class="dropdown-menu">
                                    <div class="dropdown-menu-columns">
                                        <div class="dropdown-menu-column">
                                            <div class="dropend">
                                                <a class="dropdown-item dropdown-toggle {{ Request::is('admin/laporan/pengajuan-anggota*') ? 'active' : '' }}" href="#sidebar-cards" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false" >
                                                  Pengajuan Anggota
                                                </a>
                                                <div class="dropdown-menu">
                                                    <a href="{{ route('admin.laporan.pengajuan-anggota.diterima.index') }}" class="dropdown-item {{ Request::is('admin/laporan/pengajuan-anggota/diterima*') ? 'active' : '' }}">
                                                        Diterima
                                                    </a>
                                                    <a href="{{ route('admin.laporan.pengajuan-anggota.ditolak.index') }}" class="dropdown-item {{ Request::is('admin/laporan/pengajuan-anggota/ditolak*') ? 'active' : '' }}">
                                                        Ditolak
                                                    </a>
                                                </div>
                                            </div>
