@extends('layout.staff_lapangan',['title_satu'=>'Form Edit','title_dua'=>'Anggota'])
...
@section('page-body')
<form action="{{ route('staff-lapangan.anggota.update',$anggota->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('put')
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-4 mb-3">
                    ...
                    <input type="text" name="nomor_identitas" class="form-control @error('nomor_identitas') is-invalid @enderror" value="{{ @old('nomor_identitas',$anggota->nomor_identitas) }}" placeholder="No. Identitas..">
                ...
                <div class="col-lg-4 mb-3">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-6 mb-3 mb-sm-0">
                                    ...
                                    <input type="text" name="rt" class="form-control @error('rt') is-invalid @enderror" value="{{ @old('rt',$alamat->rt) }}" placeholder="RT..">
                                    @error('rt')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-6 mb-3 mb-sm-0">
                                    <div class="form-label">RW</div>
                                    <input type="text" name="rw" class="form-control @error('rw') is-invalid @enderror" value="{{ @old('rw',$alamat->rw) }}" placeholder="RW..">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="kode_pos" class="form-control @error('kode_pos') is-invalid @enderror" value="{{ @old('kode_pos',$alamat->kode_pos) }}" placeholder="Kode Pos..">
        ...
        <div class="card-body">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-6 mb-3 mb-sm-0">
                                    <div class="form-label">RT</div>
                                    <input type="text" name="rt_usaha" class="form-control @error('rt_usaha') is-invalid @enderror" value="{{ @old('rt_usaha',$usaha->rt) }}" placeholder="RT..">
                                    @error('rt_usaha')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-6 mb-3 mb-sm-0">
                                    <div class="form-label">RW</div>
                                    <input type="text" name="rw_usaha" class="form-control @error('rw_usaha') is-invalid @enderror" value="{{ @old('rw_usaha',$usaha->rw) }}" placeholder="RW..">
                        ...
                        <div class="col-lg-6">
                            <div class="form-label">Kode Pos</div>
                            <input type="text" name="kode_pos_usaha" class="form-control @error('kode_pos_usaha') is-invalid @enderror" value="{{ @old('kode_pos_usaha',$usaha->kode_pos) }}" placeholder="Kode Pos..">
                ...
                <div class="col-lg-4 mb-3">
                    ...
                    <input type="text" name="pendapatan_perbulan" class="form-control @error('pendapatan_perbulan') is-invalid @enderror" value="{{ @old('pendapatan_perbulan',$usaha->pendapatan_perbulan) }}" placeholder="Rp..">
    ...
    <div class="card my-3">
        ...
        <div class="card-body">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-6 mb-3 mb-sm-0">
                                    <div class="form-label">RT</div>
                                    <input type="text" name="rt_usaha_pasangan" class="form-control @error('rt_usaha_pasangan') is-invalid @enderror" value="{{ @old('rt_usaha_pasangan',$usaha_pasangan->rt) }}" placeholder="RT..">
                                    @error('rt_usaha_pasangan')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-6 mb-3 mb-sm-0">
                                    <div class="form-label">RW</div>
                                    <input type="text" name="rw_usaha_pasangan" class="form-control @error('rw_usaha_pasangan') is-invalid @enderror" value="{{ @old('rw_usaha_pasangan',$usaha_pasangan->rw) }}" placeholder="RW..">
                        ...
                        <div class="col-lg-6">
                            <div class="form-label">Kode Pos</div>
                            <input type="text" name="kode_pos_usaha_pasangan" class="form-control @error('kode_pos_usaha_pasangan') is-invalid @enderror" value="{{ @old('kode_pos_usaha_pasangan',$usaha_pasangan->kode_pos) }}" placeholder="Kode Pos..">
                ...
                <div class="col-lg-4 mb-3">
                    <div class="form-label required">Pendapatan Perbulan</div>
                    <input type="text" name="pendapatan_perbulan_pasangan" class="form-control @error('pendapatan_perbulan_pasangan') is-invalid @enderror" value="{{ @old('pendapatan_perbulan_pasangan',$usaha_pasangan->pendapatan_perbulan) }}" placeholder="Rp..">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-4 mb-3">
                    ...
                    <input type="text" name="biaya" class="form-control @error('biaya') is-invalid @enderror" value="{{ @old('biaya',$anggota->registrasi->biaya) }}" placeholder="Biaya..">
...
<div class="modal modal-blur fade" id="modal-edit-provinsi" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('staff-lapangan.anggota.update-provinsi',[$anggota->id,$alamat->id]) }}" method="POST">
                @csrf
                @method('put')
...
<div class="modal modal-blur fade" id="modal-edit-jenis-usaha-anggota" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('staff-lapangan.anggota.update-jenis-usaha',[$anggota->id,$usaha->id]) }}" method="POST">
                @csrf
                @method('put')
                <div class="modal-body">
                    <div class="mb-3">
...
<div class="modal modal-blur fade" id="modal-edit-provinsi-usaha" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('staff-lapangan.anggota.update-provinsi-usaha',[$anggota->id,$usaha->id]) }}" method="POST">
                @csrf
                @method('put')
                <div class="modal-body">
                    <div class="mb-3">
...
<div class="modal modal-blur fade" id="modal-edit-jenis-usaha-pasangan" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('staff-lapangan.anggota.update-jenis-usaha-pasangan',[$usaha_pasangan->pasangan_anggota_id,$usaha_pasangan->id]) }}" method="POST">
                @csrf
                @method('put')
                <div class="modal-body">
                    <div class="mb-3">
...
<div class="modal modal-blur fade" id="modal-edit-provinsi-usaha-pasangan" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('staff-lapangan.anggota.update-provinsi-usaha-pasangan',[$usaha_pasangan->pasangan_anggota_id,$usaha_pasangan->id]) }}" method="POST">
                @csrf
                @method('put')
                <div class="modal-body">
                    <div class="mb-3">
...
<div class="modal modal-blur fade" id="modal-edit-file-identitas" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('staff-lapangan.anggota.update-identitas',[$anggota->id,$file_identitas->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="modal-body">
                    <div class="mb-3">
...
<div class="modal modal-blur fade" id="modal-edit-selfie-identitas" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('staff-lapangan.anggota.update-selfie-identitas',[$anggota->id,$file_selfie_identitas->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="modal-body">
                    <div class="mb-3">
...
<div class="modal modal-blur fade" id="modal-edit-kartu-keluarga" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('staff-lapangan.anggota.update-kartu-keluarga',[$anggota->id,$file_kartu_keluarga->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="modal-body">
                    <div class="mb-3">
...
<div class="modal modal-blur fade" id="modal-edit-bukti-pembayaran-registrasi" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('staff-lapangan.anggota.update-pembayaran-registrasi',[$anggota->id,$file_bukti_pembayaran_registrasi->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="modal-body">
                    <div class="mb-3">
