@extends('layout.branch_manager',['title_satu'=>'List','title_dua'=>'Anggota'])
            ...
            <table class="table table-vcenter card-table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="fst-italic">{{ $a->registrasi->inputer->nama_lengkap }}</td>
                            ...
                            <div class="btn-list flex-nowrap float-end">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item" href="{{ route('branch-manager.anggota.show',$a->id) }}">
                                            Detail
                                        </a>
                                    </div>
                                </div>
